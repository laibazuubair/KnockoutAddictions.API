        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddictionCategory = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalProfile = table.Column<string>(type: "text", nullable: false),
                    CurrentStreak = table.Column<int>(type: "integer", nullable: false),
                    LongestStreak = table.Column<int>(type: "integer", nullable: false),
                    TotalCheckIns = table.Column<int>(type: "integer", nullable: false),
                    LastRelapseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MorningRoundCompleted = table.Column<bool>(type: "boolean", nullable: false),
                    AfternoonRoundCompleted = table.Column<bool>(type: "boolean", nullable: false),
                    EveningRoundCompleted = table.Column<bool>(type: "boolean", nullable: false),
                    PunchingBagCompleted = table.Column<bool>(type: "boolean", nullable: false),
